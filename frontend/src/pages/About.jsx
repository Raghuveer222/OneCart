...
function About() {
  return (
    ...
    justify-center flex-col  bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]"
    >
...
justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]"
        >
          <p
            className="lg:w-[80%] w-[100%] text-[white] md:text-
    [16px] text-[13px]"
          >
...
flex-col gap-[10px]"
    ...
    lg:flex-row flex-col py-[40px]"
        >
          <div
            className="lg:w-[33%] w-[90%] h-[250px] border-
        [1px] border-gray-100 flex items-center justify-center 
        gap-[20px] flex-col px-[40px] py-[10px] text-[white] 
        backdrop-blur-[2px] bg-[#ffffff0b]"
          >
            <b
              className="text-[20px] font-semibold text-[#bff1f9]
            "
            >
              Quality Assurance
            </b>
        ...
        backdrop-blur-[2px] bg-[#ffffff0b]"
          >
            ...
            <p>
              Our dedicated support team ensures quick responses and solutions
