      ...
      switch (method) {
        ...
        case "razorpay":
          ...
          if (resultRazorpay.data.success) {
            ...
            alert(resultRazorpay.data.message);
          }
          break;
        ...
        <div className="lg:w-[70%] w-[90%] lg:h-[70%] h-[100%] flex items-center justify-center gap-[10px] flex-col">
          ...
          <div className="w-[100%] h-[30vh] lg:h-[100px] flex items-start mt-[20px] lg:mt-[0px] justify-center gap-[50px] ">
            <button
              ...
              className={`w-[150px] h-[50px] bg-white rounded-sm ${method === "razorpay" ? "border-[5px] border-blue-900" : ""}`}
            >
              <img
                src={razorpay}
            ...
            <button
              ...
              className={`w-[200px] h-[50px] bg-gradient-to-t from-[#95b3f8] to-[white] text-[14px] px-[20px] rounded-sm text-[#332f6f] font-bold ${method === "cod" ? "border-[5px] border-blue-900" : ""}`}
            >
              CASH ON DELIVERY
            </button>
          </div>
